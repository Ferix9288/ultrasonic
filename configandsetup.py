...
weights_swipeRight = Vector([-3, 1, 0, 0, -1, 3, 7, 2, -3, -4, 0, -1, -3, 0, -1, 0], SWIPE_RIGHT)
weights_swipeLeft = Vector([1, -4, 0, 0, -1, -1, 1, 0, 2, 1, -2, -1, -2, 1, -3, -1], SWIPE_LEFT)
weights_swipeUp = Vector([2, 2, -1, 0, 3, -2, -8, -2, 1, -1, 2, 7, 1, 1, -2, 0], SWIPE_UP)
weights_swipeDown = Vector([0, 0, 3, -4, -2, 5, -1, 0, -2, -1, 2, -3, 1, -1, -3, -2], SWIPE_DOWN)
weights_circle = Vector([4, 4, -1, 1, 3, 13, 2, 1, 0, 5, -1, -1, 1, 1, 6, 0], CIRCLE)
weights_v = Vector([-4, -2, 1, 1, -2, -3, 2, 0, -1, 1, 0, -1, -3, 3, 0, 4], V)
weights_caret = Vector([1, 3, -1, 2, 1, 3, 8, 1, 1, -5, 2, 3, 4, -6, 0, 1], CARET)
weights_triangle = Vector([0, -3, -2, -3, 0, 14, 5, 0, 3, 3, -3, -3, 1, 1, 3, -2], TRIANGLE)
